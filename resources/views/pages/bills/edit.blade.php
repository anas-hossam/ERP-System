...
@section('content')
    ...
    <section class="content-header">
        <h1>
            ...
            <small>عرض فاتورة</small>
            <small>تعديل فاتورة</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
            <li><a href="{{url('/bills')}}">الفواتير</a></li>
            <li><a href="{{url('/bills/'.$edit->id)}}">عرض فاتورة</a></li>
            <li class="active">تعديل فاتورة</li>
        </ol>
    </section>
    <br><br>
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border"><h3 class="box-title">تعديل فاتورة</h3></div>
                <div class="box-body">
                ...
                {!! Form::open(['route' => ['bills.update', $edit->id], 'method' => 'put']) !!}
