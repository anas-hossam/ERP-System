...
@section('content')
    ...
    <section class="content-header">
        <h1>
            المنفذين
            <small>تعديل منفذ</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{url('/')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
            <li><a href="{{url('/executers')}}">المنفذين</a></li>
            <li class="active">تعديل منفذ</li>
        </ol>
    </section>
    <br><br>
    <div class="box box-primary">
        <div class="box-body">
            ...
            {!! Form::open(['route' => ['executers.update', $edit->id], 'method' => 'put']) !!}
            <div class="row">
            ...
            <input type="submit" class="btn btn-success pull-left" value="تعديل منفذ">
